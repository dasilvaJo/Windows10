function desktopLoad() {
  document.getElementById("backgroundD").style["animation"] =
    "5s ease fadeIn both";
...
function openCalculator() {
  document.getElementById("calculator").style["animation"] =
    "0.2s ease openFile both";
  document.getElementById("windowsMenu").style["animation"] = "";
  document.getElementById("windowsMenu").style["visibility"] = "hidden";
}
...
function chromeSetURL() {
  var url = document.getElementById("chromeURL").value;
  document.getElementById("chromeIFrame").src = url;
}

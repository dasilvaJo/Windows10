...
function closeFile() {
  ...
  document.getElementById("backgroundEdit").style["animation"] = "";
  fileisOpen = false;
...
function openChrome() {
  ...
  if (chromeisOpen) {
    ...
    document.getElementById("chromeIFrame").src =
      "https://dasilvajo.github.io/RocketDesign/";
...
function openSpotify() {
  ...
  if (spotifyisOpen) {
    ...
    document.getElementById("spotifyIFrame").src =
      "https://open.spotify.com/embed/playlist/0Eve6Id0IsPPOCrk6KPMKd";
